...
def create_accounts():
    ...
    try:
        ...
        app.logger.error("Invalid JSON body: %s", str(e))
        abort(status.HTTP_400_BAD_REQUEST, "Invalid request body")
    account.create()
...
def get_accounts(account_id):
    ...
    try:
        ...
        app.logger.error("Error finding account: %s", str(e))
...
def update_accounts(account_id):
    ...
    try:
        ...
        abort(status.HTTP_400_BAD_REQUEST, "Invalid request")
